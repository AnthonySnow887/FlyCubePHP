...
class Config
{
    ...
    const TAG_WS_SERVER_HOST                = "FLY_CUBE_PHP_WEB_SOCKET_SERVER_HOST";
    const TAG_WS_SERVER_PORT                = "FLY_CUBE_PHP_WEB_SOCKET_SERVER_PORT";
    const TAG_WS_SERVER_WORKERS_NUM         = "FLY_CUBE_PHP_WEB_SOCKET_SERVER_WORKERS_NUM";
