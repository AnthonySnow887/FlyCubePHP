...
class Config
{
    ...
    const TAG_ENABLE_APCU_CACHE_PRELOAD         = "FLY_CUBE_PHP_ENABLE_APCU_CACHE_PRELOAD";
    ...
    const TAG_ENABLE_HELP_DOC_TOC               = "FLY_CUBE_PHP_ENABLE_HELP_DOC_TOC";
    const TAG_ENABLE_HELP_DOC_TOC_SORT          = "FLY_CUBE_PHP_ENABLE_HELP_DOC_TOC_SORT";
    const TAG_ENABLE_HELP_DOC_HEADING_LINKS     = "FLY_CUBE_PHP_ENABLE_HELP_DOC_HEADING_LINKS";
    const TAG_ENABLE_HELP_DOC_APPEND_DATA       = "FLY_CUBE_PHP_ENABLE_HELP_DOC_APPEND_DATA";
    const TAG_HELP_DOC_TOC_TITLE                = "FLY_CUBE_PHP_HELP_DOC_TOC_TITLE";
    const TAG_HELP_DOC_TOC_SORT_MAX_LEVEL       = "FLY_CUBE_PHP_HELP_DOC_TOC_SORT_MAX_LEVEL";
    const TAG_ENABLE_SCSS_LOGGING               = "FLY_CUBE_PHP_ENABLE_SCSS_LOGGING";
    const TAG_JS_COMPILER                       = "FLY_CUBE_PHP_JS_COMPILER";
    const TAG_PHP_SESSIONS_SAVE_PATH            = "FLY_CUBE_PHP_SESSIONS_SAVE_PATH";
    const TAG_PHP_SESSIONS_FILE_PREFIX          = "FLY_CUBE_PHP_SESSIONS_FILE_PREFIX";
    const TAG_ENABLE_ASSET_TAG_HLP_HREF_VERSION = "FLY_CUBE_PHP_ENABLE_ASSET_TAG_HLP_HREF_VERSION";
    const TAG_ASSET_TAG_HLP_HREF_VERSION_STR    = "FLY_CUBE_PHP_ASSET_TAG_HLP_HREF_VERSION_STR";
